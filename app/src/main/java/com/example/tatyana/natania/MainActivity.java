...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mSorting.equals("newest")){
            ...
            //this will load the item from bottom means newest first
            mLayoutManager.setReverseLayout(true);
            mLayoutManager.setStackFromEnd(true);
        }
        else if (mSorting.equals("oldest")){
            mLayoutManager = new LinearLayoutManager(this);
            //this will load the item from bottom means oldest first
                        ...
                        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                            ...
                            viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                                ...
                                public void onItemLongClick(View view, int position) {
                                    //TODO do your implementation on long item click
                                }
                            });
                            return viewHolder;
                        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //handle other action bar item onclick here
        ...
        if (id == R.id.action_add){
            ...
            startActivity(new Intent(MainActivity.this, AddDealsActivity.class));
            return true;
        }
